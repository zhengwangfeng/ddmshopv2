...
/*//			update-start--Author:longjb  Date:20150408 for：手动设置指定属性主题优先
			...
			if (oConvertUtils.isIn("jimmyupload", types)) {
				sb.append("<script type=\"text/javascript\" src=\"upload/JimmyUpload.js\"></script>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/layer/layer.js\"></script>");
			}
			if (oConvertUtils.isIn("layer", types)) {
				sb.append("<script type=\"text/javascript\" src=\"plug-in/layer/layer.js\"></script>");
			}
			if (oConvertUtils.isIn("Labelauty", types)) {
				sb.append("<script type=\"text/javascript\" src=\"plug-in/jquery-plugs/Labelauty/js/jquery-labelauty.js\"></script>");
				sb.append("<link rel=\"stylesheet\" type=\"text/css\" href=\"plug-in/jquery-plugs/Labelauty/css/jquery-labelauty.css\">");
			}
