...
*
 */
public class NumberComparator2 implements Comparator<Object> {
	private boolean ignoreCase = true;

	public NumberComparator2() {
	}

	public NumberComparator2(boolean ignoreCase) {
	...
	public int compare(Object obj1, Object obj2) {
		...
		String o2 = "";
		if (ignoreCase) {
			WeixinMenuEntity c1 = (WeixinMenuEntity) obj1;
			WeixinMenuEntity c2 = (WeixinMenuEntity) obj2;
			o1 = c1.getOrders();
			o2 = c2.getOrders();
		}
		if (o1 != null && o2 != null) {
