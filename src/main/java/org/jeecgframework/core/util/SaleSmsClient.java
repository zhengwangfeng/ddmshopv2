 ...
 */
public class SaleSmsClient {
    protected static String smsSvcUrl = "http://43.243.130.33:8860";	   //服务器URL 地址
    protected static String cust_code = "300501";									 //账号
    protected static String password = "RE8NBNIJFZ";		 								//密码
    protected static String sp_code = "1069035101075040";                  //接入码（扩展码）
    ...
    public static void main(String[] args) {
        SaleSmsClient client = new SaleSmsClient();
        try {
        	System.out.println("18150166685");
            client.sendMessageForContent("用户名","18150166685");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
