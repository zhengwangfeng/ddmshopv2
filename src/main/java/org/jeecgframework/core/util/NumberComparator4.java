...
*
 */
public class NumberComparator4 implements Comparator<Object> {
	private boolean ignoreCase = true;

	public NumberComparator4() {
	}

	public NumberComparator4(boolean ignoreCase) {
	...
	public int compare(Object obj1, Object obj2) {
		...
		String o2 = "";
		if (ignoreCase) {
			TcsbServiceEntity c1 = (TcsbServiceEntity) obj1;
			TcsbServiceEntity c2 = (TcsbServiceEntity) obj2;
			o1 = c1.getStateorder();
			o2 = c2.getStateorder();
		}
		if (o1 != null && o2 != null) {
