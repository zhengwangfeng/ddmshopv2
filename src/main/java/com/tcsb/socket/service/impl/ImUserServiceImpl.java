package com.tcsb.socket.service.impl;
...
@Transactional
public class ImUserServiceImpl extends CommonServiceImpl implements ImUserServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ImUser t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(ImUser t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(ImUser t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(ImUser t){
