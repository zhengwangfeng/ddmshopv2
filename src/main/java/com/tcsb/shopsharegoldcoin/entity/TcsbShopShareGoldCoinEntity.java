package com.tcsb.shopsharegoldcoin.entity;
 ...
 */
@Entity
@Table(name = "tcsb_shop_share_gold_coin", schema = "")
@SuppressWarnings("serial")
public class TcsbShopShareGoldCoinEntity implements java.io.Serializable {
	/**id*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  分享金总额
	 */
	@Column(name ="TOTAL",nullable=true,length=125)
