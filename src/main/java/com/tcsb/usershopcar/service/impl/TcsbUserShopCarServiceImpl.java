package com.tcsb.usershopcar.service.impl;
...
@Service("tcsbUserShopCarService")
@Transactional
public class TcsbUserShopCarServiceImpl extends CommonServiceImpl implements TcsbUserShopCarServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TcsbUserShopCarEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TcsbUserShopCarEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TcsbUserShopCarEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TcsbUserShopCarEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TcsbUserShopCarEntity t){
