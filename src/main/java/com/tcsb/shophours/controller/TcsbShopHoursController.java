...
public class TcsbShopHoursController extends BaseController {
	...
	public AjaxJson doAdd(TcsbShopHoursEntity tcsbShopHours, HttpServletRequest request) {
		...
		TSUser user = getCurrentUser();
		try{
			if(StringUtils.isEmpty(String.valueOf(tcsbShopHours.getShopHoursPeriodId())) || StringUtils.isEmpty(String.valueOf(tcsbShopHours.getBeginTime()))|| StringUtils.isEmpty(String.valueOf(tcsbShopHours.getEndTime()))){
