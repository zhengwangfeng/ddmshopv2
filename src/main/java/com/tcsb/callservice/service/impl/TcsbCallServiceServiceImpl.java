package com.tcsb.callservice.service.impl;
...
@Service("tcsbCallServiceService")
@Transactional
public class TcsbCallServiceServiceImpl extends CommonServiceImpl implements TcsbCallServiceServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TcsbCallServiceEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TcsbCallServiceEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TcsbCallServiceEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TcsbCallServiceEntity t){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("id", t.getId());
		map.put("shop_id", t.getShopId());
		map.put("desk_id", t.getDeskId());
		map.put("shop_service_id", t.getShopServiceId());
		map.put("count", t.getCount());
		map.put("isread", t.getIsread());
		map.put("isplay", t.getIsplay());
