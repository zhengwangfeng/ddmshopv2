package com.tcsb.shopshareuserbannerimages.service.impl;
...
@Service("tcsbShopShareUserBannerImagesService")
@Transactional
public class TcsbShopShareUserBannerImagesServiceImpl extends CommonServiceImpl implements TcsbShopShareUserBannerImagesServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TcsbShopShareUserBannerImagesEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TcsbShopShareUserBannerImagesEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TcsbShopShareUserBannerImagesEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TcsbShopShareUserBannerImagesEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TcsbShopShareUserBannerImagesEntity t){
