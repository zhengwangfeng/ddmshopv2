package com.tcsb.shopshareuserbannerimages.entity;
 ...
 */
@Entity
@Table(name = "tcsb_shop_share_user_banner_images", schema = "")
@SuppressWarnings("serial")
public class TcsbShopShareUserBannerImagesEntity implements java.io.Serializable {
	/**id*/
