package com.tcsb.fullcuttemplate.service.impl;
...
@Service("tcsbFullcutTemplateService")
@Transactional
public class TcsbFullcutTemplateServiceImpl extends CommonServiceImpl implements TcsbFullcutTemplateServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TcsbFullcutTemplateEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TcsbFullcutTemplateEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TcsbFullcutTemplateEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TcsbFullcutTemplateEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TcsbFullcutTemplateEntity t){
