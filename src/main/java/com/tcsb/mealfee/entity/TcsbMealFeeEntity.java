package com.tcsb.mealfee.entity;
 ...
 */
@Entity
@Table(name = "tcsb_meal_fee", schema = "")
@SuppressWarnings("serial")
public class TcsbMealFeeEntity implements java.io.Serializable {
	/**id*/
	 ...
	 *@return: java.lang.Double  人均餐位费
	 */
	@Column(name ="MEAL_FEE",nullable=true,length=22)
