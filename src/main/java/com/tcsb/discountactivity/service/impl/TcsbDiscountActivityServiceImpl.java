package com.tcsb.discountactivity.service.impl;
...
@Service("tcsbDiscountActivityService")
@Transactional
public class TcsbDiscountActivityServiceImpl extends CommonServiceImpl implements TcsbDiscountActivityServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TcsbDiscountActivityEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TcsbDiscountActivityEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TcsbDiscountActivityEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TcsbDiscountActivityEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TcsbDiscountActivityEntity t){
