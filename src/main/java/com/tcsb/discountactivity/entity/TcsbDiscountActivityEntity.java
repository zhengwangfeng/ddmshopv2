package com.tcsb.discountactivity.entity;
 ...
 */
@Entity
@Table(name = "tcsb_discount_activity", schema = "")
@SuppressWarnings("serial")
public class TcsbDiscountActivityEntity implements java.io.Serializable {
	/**ID*/
