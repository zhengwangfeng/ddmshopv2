package com.tcsb.userorderitem.service.impl;
...
@Service("tcsbUserOrderItemService")
@Transactional
public class TcsbUserOrderItemServiceImpl extends CommonServiceImpl implements TcsbUserOrderItemServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TcsbUserOrderItemEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TcsbUserOrderItemEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TcsbUserOrderItemEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TcsbUserOrderItemEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TcsbUserOrderItemEntity t){
