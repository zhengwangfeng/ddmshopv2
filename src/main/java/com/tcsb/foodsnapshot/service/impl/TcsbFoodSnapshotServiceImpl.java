package com.tcsb.foodsnapshot.service.impl;
...
@Service("tcsbFoodSnapshotService")
@Transactional
public class TcsbFoodSnapshotServiceImpl extends CommonServiceImpl implements TcsbFoodSnapshotServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TcsbFoodSnapshotEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TcsbFoodSnapshotEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TcsbFoodSnapshotEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TcsbFoodSnapshotEntity t){
		...
		map.put("is_dis", t.getIsDis());
		map.put("unitid", t.getUnitid());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TcsbFoodSnapshotEntity t){
 		...
 		sql  = sql.replace("#{is_dis}",String.valueOf(t.getIsDis()));
