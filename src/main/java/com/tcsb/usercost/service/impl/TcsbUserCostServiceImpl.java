package com.tcsb.usercost.service.impl;
...
@Service("tcsbUserCostService")
@Transactional
public class TcsbUserCostServiceImpl extends CommonServiceImpl implements TcsbUserCostServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TcsbUserCostEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TcsbUserCostEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TcsbUserCostEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TcsbUserCostEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TcsbUserCostEntity t){
