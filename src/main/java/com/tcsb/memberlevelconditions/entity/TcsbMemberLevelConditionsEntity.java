package com.tcsb.memberlevelconditions.entity;
 ...
 */
@Entity
@Table(name = "tcsb_member_level_conditions", schema = "")
@SuppressWarnings("serial")
public class TcsbMemberLevelConditionsEntity implements java.io.Serializable {
	/**id*/
	 ...
	 */
	@Column(name ="CHARGE",nullable=true,length=22)
