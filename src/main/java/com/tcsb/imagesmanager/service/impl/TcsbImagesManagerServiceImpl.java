package com.tcsb.imagesmanager.service.impl;
...
@Service("tcsbImagesManagerService")
@Transactional
public class TcsbImagesManagerServiceImpl extends CommonServiceImpl implements TcsbImagesManagerServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TcsbImagesManagerEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TcsbImagesManagerEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TcsbImagesManagerEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TcsbImagesManagerEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TcsbImagesManagerEntity t){
