package com.tcsb.tcsbshoppaymode.entity;
 ...
 */
@Entity
@Table(name = "tcsb_shop_paymode", schema = "")
@SuppressWarnings("serial")
public class TcsbShopPaymodeEntity implements java.io.Serializable {
	/**ID*/
	 ...
	 */
	@Column(name ="PAY_MODE",nullable=true,length=1)
