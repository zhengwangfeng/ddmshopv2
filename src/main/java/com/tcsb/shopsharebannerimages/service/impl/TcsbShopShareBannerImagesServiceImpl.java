package com.tcsb.shopsharebannerimages.service.impl;
...
@Service("tcsbShopShareBannerImagesService")
@Transactional
public class TcsbShopShareBannerImagesServiceImpl extends CommonServiceImpl implements TcsbShopShareBannerImagesServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TcsbShopShareBannerImagesEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TcsbShopShareBannerImagesEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TcsbShopShareBannerImagesEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TcsbShopShareBannerImagesEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TcsbShopShareBannerImagesEntity t){
