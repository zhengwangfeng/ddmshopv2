package com.tcsb.shopsharebannerimages.entity;
 ...
 */
@Entity
@Table(name = "tcsb_shop_share_banner_images", schema = "")
@SuppressWarnings("serial")
public class TcsbShopShareBannerImagesEntity implements java.io.Serializable {
	/**id*/
