package com.tcsb.shopfullcuttemplate.service.impl;
...
@Service("tcsbShopFullcutTemplateService")
@Transactional
public class TcsbShopFullcutTemplateServiceImpl extends CommonServiceImpl implements TcsbShopFullcutTemplateServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TcsbShopFullcutTemplateEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TcsbShopFullcutTemplateEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TcsbShopFullcutTemplateEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TcsbShopFullcutTemplateEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TcsbShopFullcutTemplateEntity t){
