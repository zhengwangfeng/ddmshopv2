package com.tcsb.shopsharedestailsimages.entity;
 ...
 */
@Entity
@Table(name = "tcsb_shop_share_destails_images", schema = "")
@SuppressWarnings("serial")
public class TcsbShopShareDestailsImagesEntity implements java.io.Serializable {
	/**id*/
