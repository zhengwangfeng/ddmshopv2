package com.weixin.weixinsubscribe.service.impl;
...
@Transactional
public class WeixinSubscribeServiceImpl extends CommonServiceImpl implements WeixinSubscribeServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(WeixinSubscribeEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(WeixinSubscribeEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(WeixinSubscribeEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(WeixinSubscribeEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,WeixinSubscribeEntity t){
