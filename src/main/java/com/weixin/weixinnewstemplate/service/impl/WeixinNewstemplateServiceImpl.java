package com.weixin.weixinnewstemplate.service.impl;
...
@Transactional
public class WeixinNewstemplateServiceImpl extends CommonServiceImpl implements WeixinNewstemplateServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(WeixinNewstemplateEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(WeixinNewstemplateEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(WeixinNewstemplateEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(WeixinNewstemplateEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,WeixinNewstemplateEntity t){
