package com.weixin.weixinnewstemplate.entity;
 ...
 */
@Entity
@Table(name = "weixin_newstemplate", schema = "")
@SuppressWarnings("serial")
public class WeixinNewstemplateEntity implements java.io.Serializable {
	/**ID*/
