package com.weixin.weixintexttemplate.service.impl;
...
@Transactional
public class WeixinTexttemplateServiceImpl extends CommonServiceImpl implements WeixinTexttemplateServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(WeixinTexttemplateEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(WeixinTexttemplateEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(WeixinTexttemplateEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(WeixinTexttemplateEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,WeixinTexttemplateEntity t){
