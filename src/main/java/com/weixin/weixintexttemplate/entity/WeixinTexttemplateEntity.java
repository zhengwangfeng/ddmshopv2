package com.weixin.weixintexttemplate.entity;
 ...
 */
@Entity
@Table(name = "weixin_texttemplate", schema = "")
@SuppressWarnings("serial")
public class WeixinTexttemplateEntity implements java.io.Serializable {
	/**ID*/
