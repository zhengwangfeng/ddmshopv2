...
<div align="center" class="container loginBg">
    ...
    <div class="login">
    	<ul class="titleName">
        	<li class="english">DDMSHOP</li>
            <li class="chinese">点单么美食系统</li>
        </ul>
        <ul class="loginInfo">
            <li>
	            <span>用户名：</span>
    ...
    <div class="copyright ">
    	<span>&copy; 点单么平台版权所有 <span class="tip"><a href="#" title=点单么商户管理系统>点单么商户管理系统</a> (推荐使用IE8+,谷歌浏览器) 技术支持：:<a href="#" title=厦门国通宝网络科技有限公司>厦门国通宝网络科技有限公司</a></span></span>
    </div>       
</div>
</form>
