...
<script type="text/javascript">
	$(function() {
		$('#functionid').tree(
				{
					checkbox : true,
					url : 'tcsbFoodController.do?setAuthority2&parentId=${parentId}',
	...
	function mysubmit() {
		var parentId = $("#rid").val();
		var s = GetNode();
		doSubmit("tcsbFoodController.do?updateAuthority2&printfunctions=" + s
				+ "&parentId=" + parentId);
	}
	function GetNode() {
...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 1px;">
		<div class="easyui-panel" style="padding: 1px;" fit="true"
			...
			<input type="hidden" name="parentId" value="${parentId}" id="rid">
