...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="tcsbDeskReservationItemController.do?doAdd"
		tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="reservationId"
					...
					<label class="Validform_label" style="display: none;">所属购物车</label>
				</td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label">
				...
				<td class="value"><textarea style="width: 600px;"
						class="inputxt" rows="6" id="foodtastefun" name="foodtastefun"></textarea>
