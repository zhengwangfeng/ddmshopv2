...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table"
		action="tcsbUserReservationShopCarController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="shopcarId" name="shopcarId"
					...
					value='${tcsbUserReservationShopCarPage.shopcarId}'> <span
			...
			<tr>
				...
				<td class="value"><input id="userId" name="userId" type="text"
					...
					value='${tcsbUserReservationShopCarPage.userId}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="createTime" name="createTime"
					...
					onClick="WdatePicker()"
					value='<fmt:formatDate value='${tcsbUserReservationShopCarPage.createTime}' type="date" pattern="yyyy-MM-dd"/>'>
			...
			<tr>
				...
				<td class="value"><input id="note" name="note" type="text"
					style="width: 150px" class="inputxt"
					value='${tcsbUserReservationShopCarPage.note}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="peopleNum" name="peopleNum"
					type="text" style="width: 150px" class="inputxt"
					value='${tcsbUserReservationShopCarPage.peopleNum}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="shopId" name="shopId" type="text"
					style="width: 150px" class="inputxt"
					value='${tcsbUserReservationShopCarPage.shopId}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="phone" name="phone" type="text"
					style="width: 150px" class="inputxt"
					value='${tcsbUserReservationShopCarPage.phone}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="sex" name="sex" type="text"
					style="width: 150px" class="inputxt"
					value='${tcsbUserReservationShopCarPage.sex}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="nickname" name="nickname"
					type="text" style="width: 150px" class="inputxt"
					value='${tcsbUserReservationShopCarPage.nickname}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="eatTime" name="eatTime"
					type="text" style="width: 150px" class="Wdate"
					onClick="WdatePicker()"
					value='<fmt:formatDate value='${tcsbUserReservationShopCarPage.eatTime}' type="date" pattern="yyyy-MM-dd"/>'>
					<span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">eatTime</label></td>
			</tr>
		</table>
	</t:formvalid>
</body>
