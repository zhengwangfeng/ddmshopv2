...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="tcsbShopHoursPeriodList" checkbox="true"
			fitColumns="false" title="营业时间段"
			actionUrl="tcsbShopHoursPeriodController.do?datagrid" idField="id"
			...
			<t:dgDelOpt title="删除"
				url="tcsbShopHoursPeriodController.do?doDel&id={id}"
				urlclass="ace_button" urlfont="fa-trash-o" />
			<t:dgToolBar title="录入" icon="icon-add"
				url="tcsbShopHoursPeriodController.do?goAdd" funname="add"></t:dgToolBar>
			<t:dgToolBar title="编辑" icon="icon-edit"
				url="tcsbShopHoursPeriodController.do?goUpdate" funname="update"></t:dgToolBar>
			<t:dgToolBar title="批量删除" icon="icon-remove"
				url="tcsbShopHoursPeriodController.do?doBatchDel"
				funname="deleteALLSelect"></t:dgToolBar>
			<t:dgToolBar title="查看" icon="icon-search"
				url="tcsbShopHoursPeriodController.do?goUpdate" funname="detail"></t:dgToolBar>
...
<script
	src="webpage/com/tcsb/shophoursperiod/tcsbShopHoursPeriodList.js"></script>
