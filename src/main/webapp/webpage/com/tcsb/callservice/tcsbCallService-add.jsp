...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="tcsbCallServiceController.do?doAdd" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="shopServiceId"
					...
					<label class="Validform_label" style="display: none;">选择的服务</label>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="value"><input id="createTime" name="createTime"
					...
					<label class="Validform_label" style="display: none;">呼叫时间</label>
				</td>
			</tr>
		</table>
	</t:formvalid>
