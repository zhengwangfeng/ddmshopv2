...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="tcsbShopBankcardController.do?doUpdate"
		tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="beneficiaryName"
					...
					class="inputxt" value='${tcsbShopBankcardPage.beneficiaryName}'
			...
			<tr>
				...
				<td class="value"><input id="beneficiaryOpeningBankName"
					...
					class="inputxt"
					value='${tcsbShopBankcardPage.beneficiaryOpeningBankName}'
					datatype="*"> <span class="Validform_checktip"></span> <label
			...
			<tr>
				...
				<td class="value"><input id="beneficiaryAccount"
					...
					class="inputxt" value='${tcsbShopBankcardPage.beneficiaryAccount}'
					datatype="n16-16|n19-19"> <span class="Validform_checktip"></span>
					<label class="Validform_label" style="display: none;">收款方客户账号</label></td>
				<td align="right"></td>
				<td class="value"></td>
			</tr>
			<%-- 	<tr>
