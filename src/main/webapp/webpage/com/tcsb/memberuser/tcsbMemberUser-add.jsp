...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="tcsbMemberUserController.do?doAdd">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
				...
				<td class="value">
					...
					datatype="*">
						...
						<c:forEach items="${membershipLevelEntitiess}"
							...
							<option value="${tcsbMemberLevelEntity.id}">${tcsbMemberLevelEntity.name}</option>
						</c:forEach>
			...
			<tr>
				...
				<td class="value"><input id="birthOfDate" name="birthOfDate"
					type="text" style="width: 150px" datatype="*" class="Wdate"
			...
			<tr>
				...
				<td class="value"><input id="mobile" name="mobile" type="text"
					...
					datatype="/^1[34578][0-9]{9}$/" errormsg="请输入正确的手机号格式"> <span
					class="Validform_checktip"></span> <label class="Validform_label"
