...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="tcsbShopCarItemController.do?doUpdate"
		tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="foodId" name="foodId" type="text"
					...
					value='${tcsbShopCarItemPage.foodId}'> <span
			...
			<tr>
				...
				<td class="value"><input id="count" name="count" type="text"
					style="width: 150px" class="inputxt"
					value='${tcsbShopCarItemPage.count}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="price" name="price" type="text"
					style="width: 150px" class="inputxt"
					value='${tcsbShopCarItemPage.price}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="createTime" name="createTime"
					...
					onClick="WdatePicker()"
					value='<fmt:formatDate value='${tcsbShopCarItemPage.createTime}' type="date" pattern="yyyy-MM-dd"/>'>
			...
			<tr>
				...
				<td class="value"><input id="updateTime" name="updateTime"
					type="text" style="width: 150px" class="Wdate"
					onClick="WdatePicker()"
					value='<fmt:formatDate value='${tcsbShopCarItemPage.updateTime}' type="date" pattern="yyyy-MM-dd"/>'>
					<span class="Validform_checktip"></span> <label
			...
			<tr>
				...
				<td class="value"><input id="shopCar" name="shopCar"
					...
					value='${tcsbShopCarItemPage.shopCar}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
