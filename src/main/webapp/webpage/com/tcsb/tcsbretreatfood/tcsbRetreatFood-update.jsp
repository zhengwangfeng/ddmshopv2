...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="tcsbRetreatFoodController.do?doUpdate"
		tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="orderId" name="orderId"
					...
					value='${tcsbRetreatFoodPage.orderId}'> <span
				...
				<td class="value"><input id="chargebackReason"
					...
					class="inputxt" value='${tcsbRetreatFoodPage.chargebackReason}'>
			...
			<tr>
				...
				<td class="value"><input id="shopId" name="shopId" type="text"
					...
					value='${tcsbRetreatFoodPage.shopId}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
				...
				<td class="value"><input id="status" name="status" type="text"
					style="width: 150px" class="inputxt"
					value='${tcsbRetreatFoodPage.status}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="foodId" name="foodId" type="text"
					style="width: 150px" class="inputxt"
					value='${tcsbRetreatFoodPage.foodId}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
				...
				<td class="value"><input id="num" name="num" type="text"
					style="width: 150px" class="inputxt"
					value='${tcsbRetreatFoodPage.num}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="updateName" name="updateName"
					type="text" style="width: 150px" class="inputxt"
					value='${tcsbRetreatFoodPage.updateName}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
				...
				<td class="value"><input id="updateDate" name="updateDate"
					...
					onClick="WdatePicker()"
					value='<fmt:formatDate value='${tcsbRetreatFoodPage.updateDate}' type="date" pattern="yyyy-MM-dd"/>'>
					<span class="Validform_checktip"></span> <label
			...
			<tr>
				...
				<td class="value"><input id="updateBy" name="updateBy"
					type="text" style="width: 150px" class="inputxt"
					value='${tcsbRetreatFoodPage.updateBy}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
				...
				<td class="value"><input id="createName" name="createName"
					type="text" style="width: 150px" class="inputxt"
					value='${tcsbRetreatFoodPage.createName}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="createBy" name="createBy"
					type="text" style="width: 150px" class="inputxt"
					value='${tcsbRetreatFoodPage.createBy}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
				...
				<td class="value"><input id="createDate" name="createDate"
					type="text" style="width: 150px" class="Wdate"
					onClick="WdatePicker()"
					value='<fmt:formatDate value='${tcsbRetreatFoodPage.createDate}' type="date" pattern="yyyy-MM-dd"/>'>
					<span class="Validform_checktip"></span> <label
