...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="tcsbOrderList" checkbox="true" fitColumns="false"
			title="订单管理" actionUrl="tcsbOrderController.do?datagrid" idField="id"
			fit="true" queryMode="group" sortName="createTime" sortOrder="desc">
			<%--<t:dgCol title="ID"  field="id"  hidden="true"  queryMode="group"  width="120"></t:dgCol>--%>
			<t:dgCol title="订单编号" field="id" align="center" query="true"
			...
			<t:dgCol title="桌位号" field="deskName" align="center" query="true"
