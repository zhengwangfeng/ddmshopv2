...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="tcsbUserShopCarController.do?doUpdate"
		tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="shopcarId" name="shopcarId"
					...
					value='${tcsbUserShopCarPage.shopcarId}'> <span
			...
			<tr>
				...
				<td class="value"><input id="openid" name="openid" type="text"
					...
					value='${tcsbUserShopCarPage.openid}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="createTime" name="createTime"
					...
					onClick="WdatePicker()"
					value='<fmt:formatDate value='${tcsbUserShopCarPage.createTime}' type="date" pattern="yyyy-MM-dd"/>'>
