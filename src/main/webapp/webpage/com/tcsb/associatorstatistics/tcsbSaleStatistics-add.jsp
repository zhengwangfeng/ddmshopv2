...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="tcsbAssociatorStatisticsController.do?send"
		tiptype="1">
		<input id="ids" name="ids" type="hidden" value="${ids }">
		<table style="width: 500px;" cellpadding="0" cellspacing="1"
			class="formtable">
			<tr>
				<td align="right"><label class="Validform_label"> 短息内容:
				</label></td>
				<td class="value"><textarea id="area" name="content"
						placeholder="请输入文本内容" rows="10" cols="50"></textarea>
					<p>
						剩余字数<span id="text-count">65</span>/65
					...
					</script> <!-- <textarea id="content" name="content" rows="10" cols="50" onPropertyChange= "textCounter(upbook.words, 50)"  ></textarea>
