...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="tcsbShopServiceController.do?doAdd" tiptype="1">
		<input id="id" name="id" type="hidden"
			value="${tcsbShopServicePage.id }">
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			class="formtable">
			<tr>
				<td align="right"><label class="Validform_label">
						所属系统服务: </label></td>
				<td class="value"><input id="serviceId" name="serviceId"
					type="text" style="width: 150px" class="inputxt"> <span
					class="Validform_checktip"></span> <label class="Validform_label"
					style="display: none;">所属系统服务</label></td>
			</tr>
			<tr>
...
<script src="webpage/com/tcsb/shopsservice/tcsbShopService.js"></script>