...
<script type="text/javascript">
	$(function() {
		$('#functionid').tree(
				{
					checkbox : true,
					url : 'tcsbShopServiceController.do?setAuthority&roleId=${shopId}',
	...
	function mysubmit() {
		var roleId = $("#rid").val();
		var s = GetNode();
		 doSubmit("tcsbShopServiceController.do?updateAuthority&rolefunctions=" + s
				+ "&roleId=" + roleId); 
	}
	function GetNode() {
...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 1px;">
		<div class="easyui-panel" style="padding: 1px;" fit="true"
			...
			<input type="hidden" name="roleId" value="${shopId}" id="rid">
