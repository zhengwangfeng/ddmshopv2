...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="tcsbOrderList" checkbox="true" fitColumns="false"
			title="订单管理"
			actionUrl="tcsbInComeController.do?incomedetaildatagrid&createTime_begin=${createTime_begin }&createTime_end=${createTime_end }"
   ...
   --%>
			...
			<t:dgCol title="线下支付方式" field="offlinePayMethod"
				replace="刷卡_1,线下微信_2,线下支付宝_3,现金_4,赊账_5" align="center"
				queryMode="group" width="80"></t:dgCol>
