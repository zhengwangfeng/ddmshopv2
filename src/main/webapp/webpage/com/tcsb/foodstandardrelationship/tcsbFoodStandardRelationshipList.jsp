...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="tcsbFoodStandardRelationshipList" checkbox="true"
			fitColumns="false" title="食物规格关联表"
			actionUrl="tcsbFoodStandardRelationshipController.do?datagrid"
			idField="id" fit="true" queryMode="group">
			<t:dgCol title="id" field="id" hidden="true" queryMode="group"
				width="120"></t:dgCol>
			<t:dgCol title="食物规格ID" field="foodStandardId" queryMode="group"
				width="120"></t:dgCol>
			<t:dgCol title="食物ID" field="foodId" queryMode="group" width="120"></t:dgCol>
			<t:dgCol title="操作" field="opt" width="100"></t:dgCol>
			<t:dgDelOpt title="删除"
				url="tcsbFoodStandardRelationshipController.do?doDel&id={id}"
				urlclass="ace_button" urlfont="fa-trash-o" />
			<t:dgToolBar title="录入" icon="icon-add"
				url="tcsbFoodStandardRelationshipController.do?goAdd" funname="add"></t:dgToolBar>
			<t:dgToolBar title="编辑" icon="icon-edit"
				url="tcsbFoodStandardRelationshipController.do?goUpdate"
				funname="update"></t:dgToolBar>
			<t:dgToolBar title="批量删除" icon="icon-remove"
				url="tcsbFoodStandardRelationshipController.do?doBatchDel"
...
<script
	src="webpage/com/tcsb/foodstandardrelationship/tcsbFoodStandardRelationshipList.js"></script>
