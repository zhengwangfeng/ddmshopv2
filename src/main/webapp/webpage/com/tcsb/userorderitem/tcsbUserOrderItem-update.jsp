...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="tcsbUserOrderItemController.do?doUpdate"
		tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="orderId" name="orderId"
					...
					value='${tcsbUserOrderItemPage.orderId}'> <span
				...
				<td class="value"><input id="foodId" name="foodId" type="text"
					...
					value='${tcsbUserOrderItemPage.foodId}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="count" name="count" type="text"
					style="width: 150px" class="inputxt"
					value='${tcsbUserOrderItemPage.count}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
				...
				<td class="value"><input id="price" name="price" type="text"
					style="width: 150px" class="inputxt"
					value='${tcsbUserOrderItemPage.price}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="foodTypeId" name="foodTypeId"
					type="text" style="width: 150px" class="inputxt"
					value='${tcsbUserOrderItemPage.foodTypeId}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
				...
				<td class="value"><input id="updateName" name="updateName"
					type="text" style="width: 150px" class="inputxt"
					value='${tcsbUserOrderItemPage.updateName}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="updateDate" name="updateDate"
					...
					onClick="WdatePicker()"
					value='<fmt:formatDate value='${tcsbUserOrderItemPage.updateDate}' type="date" pattern="yyyy-MM-dd"/>'>
				...
				<td class="value"><input id="updateBy" name="updateBy"
					type="text" style="width: 150px" class="inputxt"
					value='${tcsbUserOrderItemPage.updateBy}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="createName" name="createName"
					type="text" style="width: 150px" class="inputxt"
					value='${tcsbUserOrderItemPage.createName}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
				...
				<td class="value"><input id="createBy" name="createBy"
					type="text" style="width: 150px" class="inputxt"
					value='${tcsbUserOrderItemPage.createBy}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="createDate" name="createDate"
					type="text" style="width: 150px" class="Wdate"
					onClick="WdatePicker()"
					value='<fmt:formatDate value='${tcsbUserOrderItemPage.createDate}' type="date" pattern="yyyy-MM-dd"/>'>
					<span class="Validform_checktip"></span> <label
