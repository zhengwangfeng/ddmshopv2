...
<div class="easyui-layout" fit="true" style="height: 500px;">
	...
	<div region="center" style="padding: 0px; border: 0px;">
		<t:datagrid name="tcsbSettleAccountList" checkbox="false"
			...
			<t:dgCol title="待结算账单日期" field="waitSettleDatas"
				formatter="yyyy-MM-dd" align="center" queryMode="group" width="200"></t:dgCol>
			<t:dgCol title="结算日期" field="settleData" align="center"
				queryMode="group" formatter="yyyy-MM-dd" width="100"></t:dgCol>
			<t:dgCol title="结算金额（扣除3%手续费）" field="total" align="center"
				queryMode="group" width="160"></t:dgCol>
			...
			<t:dgFunOpt funname="myhandle(waitSettleDatas)" title="查看详情"
...
<div id="tcsbSettleAccountList"
	...
	<div name="searchColums"
		style="height: 100px; line-height: 100px; overflow: hidden; border: 1px">
