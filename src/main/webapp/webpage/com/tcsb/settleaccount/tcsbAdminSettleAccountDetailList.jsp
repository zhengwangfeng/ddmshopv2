...
<div class="easyui-layout" fit="true">
	...
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="tcsbSettleAccountList" checkbox="false"
			fitColumns="false" title="账单结算"
			actionUrl="tcsbSettleAccountController.do?datagrid&shopId=${shopId }"
			idField="id" fit="true" queryMode="group">
			<t:dgCol title="主键" field="id" hidden="true" queryMode="group"
				width="120"></t:dgCol>
			<t:dgCol title="店铺名称" field="shopName" align="center"
				queryMode="group" width="140"></t:dgCol>
			<t:dgCol title="结算周期" field="settleWeek" align="center"
				queryMode="group" width="200"></t:dgCol>
			<t:dgCol title="结算时间" field="settleData" align="center"
				queryMode="group" formatter="yyyy-MM-dd" width="100"></t:dgCol>
			<t:dgCol title="结算金额" field="total" align="center" queryMode="group"
				width="80"></t:dgCol>
			<t:dgCol title="是否已结算" field="isSettle" align="center"
				queryMode="group" dictionary="sf_yn" width="80"></t:dgCol>
			<t:dgCol title="备注" field="settleWay" align="center"
				queryMode="group" width="120"></t:dgCol>
			<t:dgCol title="操作" field="opt" width="100" align="center"></t:dgCol>
			<t:dgFunOpt funname="myhandle(id)" title="结算" exp="isSettle#eq#N"
   ...
   <t:dgToolBar title="导入" icon="icon-put" funname="ImportXls"></t:dgToolBar> --%>
		...
		<div id="tcsbSettleAccountList"
			style="padding: 1px; border: 1px; height: auto">
			<div name="searchColums"
				style="height: 70px; line-height: 70px; overflow: hidden; border: 1px">
				<table class="gridtable" style="width: 850px;">
					...
					<tr>
						<td
							style="background-color: rgba(153, 156, 158, 0.23); font-size: 14px;">${thisWaitAllMoney }</td>
						<td
							style="background-color: rgba(153, 156, 158, 0.23); font-size: 14px;">${poundage }</td>
						<td
							style="background-color: rgba(153, 156, 158, 0.23); font-size: 14px;">${waitSettleTotal }</td>
						<td
							style="background-color: rgba(153, 156, 158, 0.23); font-size: 14px;">${nextSettleData }
